...
public class TwoFactorAuthentication extends AOCRiddle {

    private static final int WIDTH = 50;
    private static final int HEIGHT = 6;
    private static final String RECHTECK = "rect ";
    ...
    public TwoFactorAuthentication(String in, int part) {
        super(in,part);
    }
    ...
    protected String solve1() {
        ...
        for(String s :getInput().split("\n")){
            if(s.startsWith(RECHTECK)){
                s = s.replaceAll(RECHTECK, "");
                String[] t = s.split("x");
                ...
                if(s.startsWith(ROW)){
                    ...
                    display = insertCopyOfColumn(display,copy,column);
                }
            }
        }
    ...
    private String[][] insertCopyOfColumn(String[][] display, String[] copy, int column) {
        for(int i = 0; i< HEIGHT;i++){
